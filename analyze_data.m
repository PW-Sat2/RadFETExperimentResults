...
load('parsed_data\wo_outliers\radfet52.mat');
load('parsed_data\wo_outliers\radfet53.mat');
load('parsed_data\wo_outliers\radfet54.mat');
load('parsed_data\wo_outliers\radfet55.mat');
load('parsed_data\wo_outliers\radfet56.mat');
load('parsed_data\wo_outliers\radfet57.mat');
load('parsed_data\wo_outliers\radfet58.mat');
load('parsed_data\wo_outliers\radfet59.mat');
load('parsed_data\wo_outliers\radfet60.mat');
load('parsed_data\wo_outliers\radfet61.mat');
...
all_data = {{komora24h64radfet, "2018-12-04 00:00:00"},...
            ...
            {radfet52converted, "2020-11-28 20:58:30"},...
            {radfet53converted, "2020-12-12 10:27:09"},...
            {radfet54converted, "2020-12-19 22:22:51"},...
            {radfet55converted, "2020-12-26 12:50:11"},...
            {radfet56converted, "2021-01-16 09:46:58"},...
            {radfet57converted, "2021-01-23 22:46:58"},...            
            {radfet58converted, "2021-02-02 23:45:18"},...            
            {radfet59converted, "2021-02-06 13:05:11"},...            
            {radfet60converted, "2021-02-16 23:39:13"},...            
            {radfet61converted, "2021-02-20 12:04:01"},...            
